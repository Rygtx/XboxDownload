...
namespace XboxDownload
{
    ...
    class ClassWeb
    {
        ...
        public static SocketPackage SslRequest(Uri uri, Byte[] send, IPAddress ip = null, Boolean decode = false, String charset = null, Int32 receivetimeout = 30000, Int32 sendtimeout = 30000)
        {
            SocketPackage socketPackage = new SocketPackage
            {
                Uri = uri
